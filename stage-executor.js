...
(function (root) {
  ...
  function phase(project, step, hasResult) {
    ...
    // ★ 2026-09-23 — **모든 단계가 「누가 맡습니까」부터.** 전에는 제작 자료·영상이
    //   「사람이 대신할 수 없다」며 고르기를 건너뛰었다. Dan: 「모든 작업은 ai or 사람
    //   둘중 선택하는 창부터 뜨게하고 ai로 선택하면 그다음 절차가 뜨게하는게 맞는거아니냐」.
    //   사람을 고를 수 없는 단계는 고르는 칸에서 그 이유를 말한다(humanAllowed).
