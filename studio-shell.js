(() => {
 ...
 const labels={'index.html':'ONECUE','studio.html':'프로젝트','new.html':'새 프로젝트','project.html':'프로젝트 진행','login.html':'계정','admin.html':'제작 관리','board.html':'콘티·영상 검수','results.html':'제작 결과물','lab.html':'LAB'};
 const rail=document.createElement('aside');rail.className='studio-rail';
 rail.innerHTML=`<a class="studio-brand" href="index.html"><b>o</b>ONECUE<span>.</span></a><div class="studio-workspace"><span>O</span><div>Creative workspace<small>광고 기획 · 제작</small></div></div><div class="studio-navlabel">WORKSPACE</div><nav><a href="index.html" ${file==='index.html'?'class="on"':''}>프로젝트</a><a href="new.html" ${file==='new.html'?'class="on"':''}>새 프로젝트</a><a href="admin.html" data-studio-admin hidden ${['admin.html','board.html'].includes(file)?'class="on"':''}>제작 관리</a><a href="results.html" data-studio-admin hidden ${file==='results.html'?'class="on"':''}>결과물 · 제작 후기</a><a href="lab.html" data-studio-admin hidden ${file==='lab.html'?'class="on"':''}>LAB · 운영 매뉴얼</a><a href="login.html" ${file==='login.html'?'class="on"':''}>계정</a></nav><div class="studio-railfoot"><a href="old/index.html">이전 사이트 ↗</a><small>ONECUE / PRODUCTION STUDIO</small></div>`;
 const projectsLink=rail.querySelector('nav a');projectsLink.href='studio.html';projectsLink.classList.toggle('on',file==='studio.html');
 document.body.prepend(rail);document.body.classList.add('studio-layout');
 const mark=document.querySelector('.topbar .mark');if(mark){mark.textContent=labels[file]||'ONECUE';mark.href='studio.html';}
