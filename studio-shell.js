(() => {
 ...
 const labels={'index.html':'ONECUE','studio.html':'프로젝트','new.html':'새 프로젝트','project.html':'프로젝트 진행','login.html':'계정','admin.html':'제작 관리','board.html':'콘티·영상 검수','results.html':'제작 결과물'};
